...
visual | how to operate
--- | ---
![sample selection module](images/README/samples.png "sample selection module") | **`drum sample options:`**<br/>_each row of this module houses a different set of drum samples for you to choose from_<br/><br/>_you can make your sample selections at anytime during the sequence_<br/><br/>**`sample sampler:`**<br/>_clicking on the triangle icon will play the currently selected option for that sample type_
![sample swapper](images/README/swapper.png "sample swapper") | **`sample swapper:`**<br/>_clicking on the gear icon will allow you to swap that row's sample type with a new one_
