...
$(document).ready(function () {
	...
	$('.randomization_checkbox').click(function () {
		...
		// disable pseudorandom options for unchecked parent options
	...
	// when a random shared sequence is requested, serve one up
